...
#define BLUE "\033[34m"                     //colour defination
...
cout<<RED<<   "############################################################"<<endl;
        cout<<"#                                                           #"<<endl;
cout<<GREEN<< "#        WELCOME TO STUDENT MANAGEMENT SYSTEM               #"<<endl;
        cout<<"#                                                           #"<<endl;
cout<<YELLOW<<"#            STUDENT MANAGEMENT SYSTEM                      #"<<endl;
cout<<YELLOW<<"#                                                           #"<<endl;
cout<<BLUE<<  "#        * ADD STUDENT                                      #"<<endl;
cout<<BLUE<<  "#        * VIEW STUDENT                                     #"<<endl;
cout<<BLUE    "#        * STUDENT FEE CALCULATION                          #"<<endl;
cout<<BLUE    "#        * UPDATE STUDENT DATA                              #"<<endl;
cout<<BLUE    "#        * DELETE STUDENT DATA                              #"<<endl;
        cout<<"#                                                           #"<<endl;
cout<<MAGENTA "#        DEVELOPED BY: MIAN HASSNAIN                        #"<<endl;
cout<<RED<<   "############################################################"<<endl;
    cout<<"                                        "<<endl;
        }
...
int main() {
    ...
    while (true) {
        ...
        line();
        cout << "Developer: " << GREEN << "Hassnain" << RESET << "\n";
        line();
        cout << "1. Admin Login\n2. User Login\n3. Sign Up\n4. Exit\n";
        cout << "Choice: ";
        while (!(cin >> choice)) 
